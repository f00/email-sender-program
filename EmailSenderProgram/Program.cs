			...
			List<Customer> e = DataLayer.ListCustomers();
				...
				for (int i = 0; i < e.Count; i++)
				{
					...
					if (e[i].CreatedDateTime > DateTime.Now.AddDays(-1))
					{
                        ...
                        //Send mail from info@thecompany.com
                        m.From = new System.Net.Mail.MailAddress("info@thecompany.com");
						//Add body to mail
						m.Body = "Hi " + e[i].Email +
			...
			try
			{
				...
				foreach (Customer c in e)
				{
					...
					if (Send == true)
					{
                        ...
                        //Send mail from info@thecompany.com
                        m.From = new System.Net.Mail.MailAddress("infor@thecompany.com");
						//Add body to mail
						m.Body = "Hi " + c.Email +
